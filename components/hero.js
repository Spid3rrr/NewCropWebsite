        ...
        <div className="flex items-center w-full lg:w-1/3">
          <div className="max-w-2xl mb-8">
            <h1 className="text-2xl font-bold leading-snug tracking-tight text-gray-800 lg:text-2xl lg:leading-tight xl:text-4xl xl:leading-tight dark:text-white">
              Bringing the freshness of our fields to your doorstep
            </h1>
            <p className="py-5 text-lg leading-normal text-gray-500 lg:text-lg xl:text-xl dark:text-gray-300">
              At NewCrop, we pride ourselves on providing the highest quality
              produce to our customers. We source only the freshest fruits and
              vegetables from the most trusted growers around the world. So
              whether you're a chef looking to create a masterpiece or a family
              seeking to savor the taste of summer, you can trust NewCrop to
              deliver the very best nature has to offer.
            </p>
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <Link href="/">
                <a
                  href="/"
                  className="px-8 py-4 text-lg font-medium text-center text-white bg-green rounded-md "
                >
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Partnered with over <span className="text-green">50+</span>{" "}
            companies worldwide
          </div>
